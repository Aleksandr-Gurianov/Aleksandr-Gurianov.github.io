...
export default class Sidebar extends React.Component {
    ...
    //             transition={{ duration: 2.5 }}
        ...
        return (
            <motion.div className={ containerClassnames } variants={variantsBasic} 
            ...
            >
                ...
                initial='initial'
                animate='animate'
                // onClick={() => !isOpened && console.log('12')}
                ...
                >
                    ...
                    {isVisible ? '' : 
                    <Tooltip classcomponent={'hiddenProfile'} > 
                    ...
                    {/* {isOpened ? '' : 
                    <Tooltip classcomponent={'hiddenProfile'} className={isVisible? '123': '321'}> 
                    <div className="infoPerson">
                        <img src={userInfo.photo} alt={userInfo.name} />
                        <div className="infoPerson__contact">
                            <h3>{userInfo.name}</h3>
